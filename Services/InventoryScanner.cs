...
namespace CriticalCommonLib.Services
{
    ...
    public class InventoryScanner : IInventoryScanner
    {
        ...
        [Signature("E8 ?? ?? ?? ?? E9 ?? ?? ?? ?? 48 8B D7 8B CE E8 ?? ?? ?? ?? E9 ?? ?? ?? ?? 48 8B D7 8B CE E8 ?? ?? ?? ?? E9 ?? ?? ?? ?? 48 8B D7 8B CE E8 ?? ?? ?? ?? E9 ?? ?? ?? ?? 48 8D 57", DetourName = nameof(ContainerInfoDetour), UseFlags = SignatureUseFlags.Hook)]
